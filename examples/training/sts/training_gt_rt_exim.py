...
dataset_path = '/home/ruinian/IVALab/Project/TaskGrounding/sentence-transformers/datasets/gt_rt_exim_small_sample.csv'
...
with open(dataset_path, newline='') as csvfile:
    ...
    for row in reader:
        ...
        label = np.random.uniform(low=0.9, high=1.0)
